...
export default function CreatePage() {
  ...
  return (
        ...
        <div className='my-8'>
            ...
            <input type="text" placeholder="Keep title precise and small" 
            name = "title"
        ...
        <div className='my-8 flex flex-col'>
            ...
            <select className="select select-bordered w-full my-4 focus:outline-none"
            name = "state"
        ...
        <div className='my-8'>
            ...
            <input type="text" placeholder = "Tagname" className="input input-bordered w-full focus:outline-none" 
            name = "currentTag" value = {tagIp} onChange = {(e) => setTagIp(e.target.value)} />
            <button className = "btn my-4" onClick={handleAdd}>Add</button>

            <div className='my-4 w-full flex flex-wrap'>
              {tags.map((tag,index) => <DropDownCard text={tag} key={index} />)}
            </div>
        </div>


        <div className='w-full flex justify-center'>
        <button type = "submit" className="btn w-40 rounded-full border-none bg-sec hover:bg-sec-dark mx-auto">Post</button>
        </div>
        </div>
        </form>
    </div>
