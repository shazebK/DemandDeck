...
export default function CreatePage() {
  return (
    <div className='w-full my-8 px-4'>
        <h1 className = "md:text-[48px] text-center font-bold">Create Your Demand</h1>
        ...
        <div className='my-8'>
            ...
            <input type="text" placeholder="Keep title precise and small" className="input input-bordered w-full focus:outline-none" />
        </div>
        ...
        <button className="btn w-40 rounded-full border-none bg-sec hover:bg-sec-dark mx-auto">Post</button>
        </div>
